...
class ColorEarth {
    ...
    renderToTile(gl: any, tileId: any) {
        console.log(this.frame, 'renderToTile')
        console.log(tileId, this.map.getZoom())
    ...
    render(gl: any, matrix: any) {
        console.log(this.frame, 'render')
        this.frame++
    }
};


function getColor(tileId: any) {
